...
define asahi = Character("晨宝", color="#fda0a5")
define bf = Character("毕方", color="#fcce9a")
define ly = Character("六翼", color="#a4faa1")
define bl = Character("冰蓝", color="#95f3ff")
define jj = Character("江江", color="#728A6A")
define o27 = Character("027", color="#236a00")
define hb = Character("红白", color="#B93737")
define xq = Character("袭秋", color="#B4E3CF")
